...
const
  NotifyAttribute: array[TNotifyType] of TNotifyAttribute = (
    (Reliable: True; Permanent: False; Redirect: False),
    (Reliable: True; Permanent: False; Redirect: False),
    (Reliable: True; Permanent: False; Redirect: False),
    (Reliable: False; Permanent: False; Redirect: True),
    (Reliable: False; Permanent: True; Redirect: True),
    (Reliable: False; Permanent: True; Redirect: True),
    (Reliable: False; Permanent: True; Redirect: True),
    (Reliable: False; Permanent: True; Redirect: True),
    (Reliable: False; Permanent: True; Redirect: True),
...
begin
  ...
  if Available(Connector) then
    Parser := TCustomConnector(Connector).RemoteParser;
end;

function TPlugin.FindParser: Boolean;
begin
  if not Available(Parser) and Available(Connector) then
    Parser := TCustomConnector(Connector).RemoteParser;
